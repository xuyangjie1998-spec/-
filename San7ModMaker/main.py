...
from core.asm_analyzer import AsmAnalyzer
from core.resource_reverse import ResourceReverseEngine, FormatDetector, IntegrityChecker, BinaryTemplateGenerator
from core.game_debugger import GameDebugger
from core.ai_analyzer import AIAnalyzer
from core.save_crypto import SaveFileAnalyzer
from core.call_tracer import CallTracerEngine
from core.binary_diff import BinaryDiffAnalyzer
from core.script_vm import ScriptVMEngine
from core.code_inject import CodeInjectEngine
from core.anti_debug import AntiDebugEngine
from core.deobfuscator import DeobfuscatorEngine
...
# 应用主类
# ============================================================
class San7ModMaker(EngineBreakthroughMixin):
    """MOD制作器主应用"""
    ...
    def __init__(self):
        ...
        self.scriptso_dynamic = ScriptSODynamic()
        self.memory_scanner = MemoryScanner()
        self.asm_analyzer = AsmAnalyzer()
        self.resource_reverse = ResourceReverseEngine()
        self.game_debugger = GameDebugger()
        self.ai_analyzer = AIAnalyzer()
        self.save_crypto = SaveFileAnalyzer()
        self.call_tracer = CallTracerEngine()
        self.binary_diff = BinaryDiffAnalyzer()
        self.script_vm = ScriptVMEngine()
        self.code_inject = CodeInjectEngine()
        self.anti_debug = AntiDebugEngine()
        self.deobfuscator = DeobfuscatorEngine()
...
"""
    ...
    def run(self):
        ...
        window = webview.create_window(
            title="San7ModMaker - 三国群英传7 MOD制作器 V3.17.0",
            url=html_path,
            js_api=api,
            width=1280,
            height=860,
