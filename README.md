# San7ModMaker - 三国群英传7 MOD制作器 V3.2.1
...
- **新增** 数据仪表盘：首页实时统计武将/兵种/物品/技能等数据量
- **新增** 深色/浅色主题切换，支持本地记忆
- **新增** SHP批量转换工具（PNG目录→SHP，支持GenFace/ThingIcon/genhalf）
- **新增** 批量重命名功能（支持武将/兵种/物品/技能/官职等）
- **新增** 自动备份清理（保留最近10个快照）
- **新增** SG7Setting文档全面应用：47个Schema + 4个参考数据文件 + 21个xlsx数据表
- **新增** 三大MOd制作流程：新势力/新武将+头像CG/新物品+图标 完整向导
- **新增** 参考数据服务：编辑器内自动显示原版属性对比
